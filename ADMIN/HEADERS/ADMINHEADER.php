...
<li><a href="ADDMEDICINE.php">ADD MEDICINE</a></font></li>
<li><font color="#FFFFFF">STOCK-INFO</font>
	<ul>
		<li><a href="STORE.php">CHECK-STOCK</a></li>
	</ul>
    </li>
<li><font color="#FFFFFF">MONEY</font>
	<ul>
		<li><a href="PAYMENT.php">ORDERS</a></li>
